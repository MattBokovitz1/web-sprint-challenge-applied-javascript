...
1. What is the DOM?
A user interface that allows us to manipulate the page
2. What is an event?
An action that takes place when a click, hover, or similar feature occurs over an element
3. What is an event listener?
attaches a event handler to the element
4. Why would we convert a NodeList into an Array?
So we can do array methods
...
- [ check] Following the instructions in the `components/Header.js` file, create the Header.

- [ check] Following the instructions in the `components/Tabs.js` file, create the Tabs.

- [check ] Following the instructions in the `components/Cards.js` file, create the Cards.
